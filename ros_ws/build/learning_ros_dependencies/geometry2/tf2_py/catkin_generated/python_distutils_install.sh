...
echo_and_run cd "/home/abcaps35/ros_ws_nogit/src/learning_ros_dependencies/geometry2/tf2_py"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abcaps35/ros_ws_nogit/src/learning_ros_dependencies/geometry2/tf2_py/setup.py" \
    egg_info --egg-base /home/abcaps35/ros_ws_nogit/build/learning_ros_dependencies/geometry2/tf2_py \
    build --build-base "/home/abcaps35/ros_ws_nogit/build/learning_ros_dependencies/geometry2/tf2_py" \
    install \
    --root="${DESTDIR-/}" \
