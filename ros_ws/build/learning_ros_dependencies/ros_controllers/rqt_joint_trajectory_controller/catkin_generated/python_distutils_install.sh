...
echo_and_run cd "/home/abcaps35/ros_ws_nogit/src/learning_ros_dependencies/ros_controllers/rqt_joint_trajectory_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abcaps35/ros_ws_nogit/src/learning_ros_dependencies/ros_controllers/rqt_joint_trajectory_controller/setup.py" \
     \
    build --build-base "/home/abcaps35/ros_ws_nogit/build/learning_ros_dependencies/ros_controllers/rqt_joint_trajectory_controller" \
    install \
    --root="${DESTDIR-/}" \
