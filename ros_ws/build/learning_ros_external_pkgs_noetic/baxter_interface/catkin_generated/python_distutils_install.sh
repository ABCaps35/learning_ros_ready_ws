...
echo_and_run cd "/home/abcaps35/ros_ws_nogit/src/learning_ros_external_pkgs_noetic/baxter_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abcaps35/ros_ws_nogit/src/learning_ros_external_pkgs_noetic/baxter_interface/setup.py" \
     \
    build --build-base "/home/abcaps35/ros_ws_nogit/build/learning_ros_external_pkgs_noetic/baxter_interface" \
    install \
    --root="${DESTDIR-/}" \
