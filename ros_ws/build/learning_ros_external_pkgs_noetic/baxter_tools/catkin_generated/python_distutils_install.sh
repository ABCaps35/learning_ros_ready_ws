...
echo_and_run cd "/home/abcaps35/ros_ws_nogit/src/learning_ros_external_pkgs_noetic/baxter_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abcaps35/ros_ws_nogit/src/learning_ros_external_pkgs_noetic/baxter_tools/setup.py" \
     \
    build --build-base "/home/abcaps35/ros_ws_nogit/build/learning_ros_external_pkgs_noetic/baxter_tools" \
    install \
    --root="${DESTDIR-/}" \
