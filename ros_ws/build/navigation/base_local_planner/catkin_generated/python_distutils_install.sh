...
echo_and_run cd "/home/abcaps35/ros_ws/src/navigation/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abcaps35/ros_ws/src/navigation/base_local_planner/setup.py" \
     \
    build --build-base "/home/abcaps35/ros_ws/build/navigation/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
