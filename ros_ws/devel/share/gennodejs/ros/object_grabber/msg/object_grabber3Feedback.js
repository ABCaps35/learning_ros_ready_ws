...
class object_grabber3Feedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new object_grabber3Feedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_grabber3Feedback(null);
...
module.exports = object_grabber3Feedback;
