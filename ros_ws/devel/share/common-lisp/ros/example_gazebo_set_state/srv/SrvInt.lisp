...
(cl:in-package example_gazebo_set_state-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvInt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvInt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_gazebo_set_state-srv:<SrvInt-request> is deprecated: use example_gazebo_set_state-srv:SrvInt-request instead.")))

(cl:ensure-generic-function 'request_int-val :lambda-list '(m))
(cl:defmethod request_int-val ((m <SrvInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_gazebo_set_state-srv:request_int-val is deprecated.  Use example_gazebo_set_state-srv:request_int instead.")
  (request_int m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvInt-request>)))
  ...
  "example_gazebo_set_state/SrvIntRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvInt-request)))
  "Returns string type for a service object of type 'SrvInt-request"
  "example_gazebo_set_state/SrvIntRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvInt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvInt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_gazebo_set_state-srv:<SrvInt-response> is deprecated: use example_gazebo_set_state-srv:SrvInt-response instead.")))

(cl:ensure-generic-function 'response_int-val :lambda-list '(m))
(cl:defmethod response_int-val ((m <SrvInt-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_gazebo_set_state-srv:response_int-val is deprecated.  Use example_gazebo_set_state-srv:response_int instead.")
  (response_int m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvInt-response>)))
  ...
  "example_gazebo_set_state/SrvIntResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvInt-response)))
  "Returns string type for a service object of type 'SrvInt-response"
  "example_gazebo_set_state/SrvIntResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvInt)))
  ...
  "example_gazebo_set_state/SrvInt")