...
(cl:defmethod cl:initialize-instance :after ((m <trajGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'trajGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm7dof_traj_as-msg:<trajGoal> is deprecated: use arm7dof_traj_as-msg:trajGoal instead.")))

(cl:ensure-generic-function 'trajectory-val :lambda-list '(m))
(cl:defmethod trajectory-val ((m <trajGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm7dof_traj_as-msg:trajectory-val is deprecated.  Use arm7dof_traj_as-msg:trajectory instead.")
  (trajectory m))
