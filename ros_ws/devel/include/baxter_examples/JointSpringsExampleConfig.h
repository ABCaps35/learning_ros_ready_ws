...
namespace joint_torque
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(JointSpringsExampleConfig &config, const JointSpringsExampleConfig &max, const JointSpringsExampleConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const JointSpringsExampleConfig &config1, const JointSpringsExampleConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, JointSpringsExampleConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const JointSpringsExampleConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, JointSpringsExampleConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const JointSpringsExampleConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const JointSpringsExampleConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, JointSpringsExampleConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
