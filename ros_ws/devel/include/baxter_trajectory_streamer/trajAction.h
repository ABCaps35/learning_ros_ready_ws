...
bool operator==(const ::baxter_trajectory_streamer::trajAction_<ContainerAllocator1> & lhs, const ::baxter_trajectory_streamer::trajAction_<ContainerAllocator2> & rhs)
{
