...
bool operator==(const ::baxter_trajectory_streamer::trajActionResult_<ContainerAllocator1> & lhs, const ::baxter_trajectory_streamer::trajActionResult_<ContainerAllocator2> & rhs)
{
